        ...
        <div className="grid gap-10 lg:grid-cols-2">
          ...
          <div>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              ...
              <button
                onClick={() => { cart.add(product.id, qty); router.push("/checkout/shipping"); }}
                disabled={!inStock}
          ...
          <div className="mt-6">
            {tab === "description" && (
              <p className="max-w-3xl leading-relaxed text-foreground/85">
                {product.description} Each piece is curated and quality-checked before shipping.
              </p>
            )}
            {tab === "specs" && (
            ...
            {tab === "reviews" && (
              <div className="space-y-4">
                {[
                  { n: "Aisha K.", r: 5, t: "Honestly the best purchase I've made this year." },
                  { n: "Daniel M.", r: 4, t: "Solid quality, arrived quickly. Would recommend." },
                  { n: "Fatima A.", r: 5, t: "Looks even better than the pictures." },
                ].map((rv) => (
                  <div key={rv.n} className="rounded-2xl border border-border bg-card p-5">
